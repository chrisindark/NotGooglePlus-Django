...
#             os.path.join(settings.PROJECT_PATH, settings.MEDIA_PATH + dirname)
#         )
...
#             thumb_result = None
#             print(
#                 "Failed to generate thumbnail file for %s to %s"
...
#             mp4_result = None
#             print(
#                 "Failed to convert video file %s to %s"
...
#             "stream_segment",
#             "-segment_list",
#             output_file_path + "playlist.m3u8",
#             "-segment_list_flags",
#             "live",
#             "-segment_time",
#             "10",
#             output_file_path + "out%03d.ts",
#         ]
#         try:
...
#             hls_result = None
#             print(
#                 "Failed to generate hls video for %s to %s"
#                 % (input_file_path, output_file_path + "playlist.m3u8")
#             )
